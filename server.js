...
app.get("/api/ratings", async (req, res) => {
  ...
  //     // .build();
  //     .usingServer("https://final-dashboard-15ef7bba4916.herokuapp.com/")
  //     .withCapabilities(capabilities)
  //     .build();

  //   // Get the link
  //   await driver.get(glassDoorLinks[glassIter].link);
  ...
  //   console.log(
  //     "Push " + glassDoorLinks[glassIter].company + " to ratings... " + rating
  //   );
  //   await driver.quit();
  ...
  //   res.json({
  //     express: { Company: glassDoorLinks[glassIter].company, Rating: rating },
  //   });
  ...
  console.log("WTF");
  await page.goto(glassDoorLinks[glassIter].link);
  // const rating = await page.$eval('//*[@id="EmpStats"]/div/div[1]/div/div/div', el => el.textContent)
  // console.log(
  //     "Push " + glassDoorLinks[glassIter].company + " to ratings... " + rating
  //     );
  console.log("CLOSE");
